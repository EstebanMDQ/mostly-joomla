...
var yxDays=new Array("Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sábado", "Domingo");
...
function addCalendar(name, title, field, form) {
  ...
  calMethod_popup = calMethod_popup || isOpera
}
...
function hideCal() {
  if(calMethod_popup) { calWin.close(); calWin = null; }else{ calWin.style.visibility='hidden' };
  window.status = "";
}
...
function calTitle(d) {
  ...
  if(calMethod_popup) {
    ...
    if (titleMode == 2) {
        s="<tr align='center' bgcolor='"+titleColor+"'><td colspan='7'>\n<table cellpadding='0' cellspacing='0' border='0'><tr align='center' valign='middle'><td align='right'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:self.moveYear(-10)'>&nbsp;&#171;</a>&nbsp;"+a1("titlea")+"'javascript:self.moveYear(-1)'>&#139;&nbsp;</a></b>"+span2+"</td><td width='"+titleWidth+"'><b>"+span1("title")+yy+span2+"</b></td><td align='left'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:self.moveYear(1)'>&nbsp;&#155;</a>&nbsp;"+a1("titlea")+"'javascript:self.moveYear(10)'>&#187;&nbsp;</a></b>"+span2+"</td></tr><tr align='center' valign='middle'><td align='right'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:self.prepMonth("+d.getMonth()+")'>&nbsp;&#139;&nbsp;</a></b>"+span2+"</td><td width='"+titleWidth+"'><b>"+span1("title")+mm+span2+"</b></td><td align='left'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:self.nextMonth("+d.getMonth()+")'>&nbsp;&#155;&nbsp;</a></b>"+span2+"</td></tr></table>\n</td></tr><tr align='center' bgcolor='"+daysColor+"'>";
    }
    else {
        s="<tr align='center' bgcolor='"+titleColor+"'><td colspan='7'>\n<table cellpadding='0' cellspacing='0' border='0'><tr align='center' valign='middle'><td>"+span1("title")+"<b>"+a1("titlea")+"'javascript:self.moveYear(-1)'>&nbsp;&#171;</a>&nbsp;"+a1("titlea")+"'javascript:self.prepMonth("+d.getMonth()+")'>&#139;&nbsp;</a></b>"+span2+"</td><td width='"+titleWidth+"'><nobr><b>"+span1("title")+mm+" "+yy+span2+"</b></nobr></td><td>"+span1("title")+"<b>"+a1("titlea")+"'javascript:self.nextMonth("+d.getMonth()+")'>&nbsp;&#155;</a>&nbsp;"+a1("titlea")+"'javascript:self.moveYear(1)'>&#187;&nbsp;</a></b>"+span2+"</td></tr></table>\n</td></tr><tr align='center' bgcolor='"+daysColor+"'>";
    }
  }
...
function calFooter() {
  if(calMethod_popup) {
    ...
    return "<tr bgcolor='"+footColor+"'><td colspan='7' align='center'>"+span1("foot")+"<b>"+a1("foota")+"'javascript:self.hideCal()'>"+yxLinks[0]+"</a>&nbsp;&nbsp;"+a1("foota")+"'javascript:self.clearDate()'>"+yxLinks[1]+"</a></b>"+span2+"</td></tr></table>\n</td></tr></table>\n</body>";
  }
}
    ...
    for (var j=weekDay; j<weekDay+7; j++) {
      if (i*7+j<fd || dayCount>ld) {
        ...
        if(calMethod_popup) {
          ...
          s+="<td bgcolor='"+bgColor+"'>"+span1(fgTag)+a1(fgTagA)+"'javascript: self.pickDate("+dayCount+")'>"+(dayCount++)+"</a>"+span2+"</td>";
        }
      }
    }
    s+="</tr>";
...
function markClick(e) {
  ...
  if(self.qfdc_pc) eval(self.qfdc_pc);
  return true;
}
...
function showCal(name) {
  ...
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
    ...
    if(calMethod_popup) {
        ...
        if(document.all) calWin = document.all['qfcal_'+currentCal.name];
        else if(document.getElementById) calWin = document.getElementById('qfcal_'+currentCal.name)
        calWin.innerHTML=calendar
        calWin.style.visibility='visible'
    }
...
function pickDate(d) {
  ...
  var s = new String(currentCal.form[currentCal.field].value);
  var aux = s.split(' ');
  currentCal.form[currentCal.field].value=date;
  if( aux.length>1 ){
	  currentCal.form[currentCal.field].value+= ' '+aux[1];
  }
...
var qform_showCal_bag={}
function qform_showCal(name, title, field, form) {
    if(!qform_showCal_bag[name]) {
        addCalendar(name, title, field, form);
        qform_showCal_bag[name]=1;
    }
    self.showCal(name);
}
